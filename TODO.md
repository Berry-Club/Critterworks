...
- A Chunkloader attachment
	- Would be very funny if it's literally the block from ChickenChunks just on their spine
	- SavedData that force loads those on server start
	- I don't like there being a resource cost for chunk loading though
		- Having them chunk load by DEFAULT would be awful though
